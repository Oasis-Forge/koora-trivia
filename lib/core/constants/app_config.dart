...
class AppConfig {
  ...
  /// عملات حزمة الشراء الصغيرة: ملآن للقلوب (200 لكل منهما) وبقية.
  ///
  /// العملات بلا سقف بخلاف القلوب: القلوب لا تتجاوز [maxHearts] مهما دفع
  /// اللاعب، فنبيع ما يشتريها لا القلوب نفسها.
  static const int coinsPerSmallPack = 500;

  /// عملات الحزمة الكبيرة — أربعة أضعاف الصغيرة بسعر أقل للعملة الواحدة.
  static const int coinsPerLargePack = 2000;
