...
class AppConfig {
  ...
  /// سعر حماية السلسلة بالعملات (قرار المالك، 19 سبتمبر 2026).
  ///
  /// فوق دخل يوم كامل من المهام (130) عمداً: لا يشتريها يوم واحد من المهام،
  /// فتحتاج يومين أو إعلاناً مكافأً معه.
  static const int priceStreakShield = 250;

  /// أقصى عدد من الحمايات يحمله اللاعب. واحدة فقط: من يخزّن عدة حمايات يستطيع
  /// أن يترك التحدي أياماً والسلسلة قائمة، فتفقد معناها.
  static const int maxStreakShields = 1;

  /// عملات تُمنح مرة واحدة حين تبلغ السلسلة أول مرة كل عدد من الأيام.
  ///
  /// مرة واحدة لأنها تُحسب على «أفضل سلسلة»: من انقطعت سلسلته وأعاد بناءها لا
  /// يأخذها ثانية.
  static const Map<int, int> streakMilestoneCoins = {7: 50, 30: 150, 100: 400};
