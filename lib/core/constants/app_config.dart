...
class AppConfig {
  ...
  /// عملات حزمة الشراء: ملء واحد للقلوب أو حزمة مساعدات واحدة.
  ///
  /// العملات بلا سقف بخلاف القلوب: القلوب لا تتجاوز [maxHearts] مهما دفع
  /// اللاعب، فنبيع ما يشتريها لا القلوب نفسها.
  static const int coinsPerSmallPack = 200;
  ...
  /// مساعدات تُمنح مقابل إعلان مكافأ حين تنفد مساعدات اللاعب داخل المستوى.
  ///
  /// بلا حدّ يومي عمداً: العملات مقابل الإعلان بلا حدّ أصلاً (3 إعلانات ≈ 210
  /// عملة ≈ حزمة من 3 مساعدات)، فمساعدة لكل إعلان هي السعر نفسه بطريق أقصر.
  ...
  /// أقصى ارتفاع للشريط في شاشة السؤال كنسبة من ارتفاع الشاشة.
  ///
  /// الشريط المتكيّف قد يبلغ 15% من الشاشة؛ على هاتف 640 يدفع ذلك الخيار
  /// الرابع تحت الحافة والوقت يجري. فوق هذه النسبة يعود الشريط إلى 320×50.
  static const double quizBannerMaxHeightFraction = 0.1;
