...
import 'presentation/widgets/app_language_scope.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Selector<SettingsProvider, (String, String?)>(
        ...
        // اللغات من ملفات الترجمة في lib/l10n (العربية والإنجليزية)، واتجاه
        ...
        // لغة النصوص تُطبَّق هنا تحت `Localizations`، بعد أن يحسمها `MaterialApp`.
        builder: (context, child) => AppLanguageScope(
          child: AppLifecycleHooks(
