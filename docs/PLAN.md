...
- 19 September 2026 (owner's choice: mixed style): sounds — a chime and a soft falling tone for right and wrong answers, a tick in the last 5 seconds, a referee whistle at time-up and at the daily's kick-off, a crowd cheer for a level pass, an air horn with a big cheer and confetti for 3 stars or a new best score, a coin clink wherever coins arrive. They follow the Settings sound switch, mix with the player's music, and stop before ads. For the next version.
