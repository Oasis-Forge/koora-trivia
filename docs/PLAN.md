...
- English store screenshots: 5 × 1080×1920 in `screenshots/store_9x16_en/` (home, categories, levels, question, answer feedback) for the en-US listing. The uploaded Arabic set still shows the design before v1.0.6.
