...
- 15 September 2026 (owner, Play Console): v1.0.6 is on internal and closed testing · the Arabic and English v1.0.6-design screenshots are uploaded · the "Some languages have errors" warning is gone. Left: the pre-launch report once Google approves.
