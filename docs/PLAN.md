...
- 16 September 2026: app-ads.txt set as the Play listing's Website and verified in AdMob (owner) · the 32 merged PR branches deleted · v1.0.7+8 built and archived for the owner's phone test (no full test run or emulator check, owner's call).
