...
- 18 September 2026 (owner's request): the support email is `oasisforge.support@gmail.com` — in the app's feedback and report emails and in the privacy policy source. The live privacy page and the Oasis Forge home page change in Oasis-Forge/koora-trivia-privacy#1 and Oasis-Forge/oasis-forge.github.io#1 (merging publishes them). Left: Play Console's store contact (owner).
