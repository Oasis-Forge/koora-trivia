...
- 18 September 2026 (owner's request): the support email is `oasisforge.support@gmail.com` — in the app's feedback and report emails and in the privacy policy source. Left: publish the privacy page, the Oasis Forge home page, and Play Console's store contact.
