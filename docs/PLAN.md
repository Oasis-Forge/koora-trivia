...
### Release & tech debt
- **P0 · S · owner**: Finish the payments profile (under verification on 17 September 2026), then create the three products in Play Console with ids `coins_small`, `coins_large`, `remove_ads`, set their prices, and add a licence tester to buy without paying. Nothing sells until this is done.
