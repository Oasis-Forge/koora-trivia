...
| Closed testing | ✅ running · ⚠️ testers | Track **Alpha**: available since **9 September 2026** with v1.0.3 (versionCode 4), 177 countries; latest upload v1.0.11 (versionCode 12, 19 September 2026). **12 testers opted in** (ticked in Play Console by 19 September); new personal accounts need them opted in for **14 consecutive days** before requesting production — about 3 October 2026 |
| Production | ⏳ | |
