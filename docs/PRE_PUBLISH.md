...
| `1.0.10+11` | PR #69: streak protection for 250 coins · streak rewards at 7, 30 and 100 days · Skip says it doesn't count as correct (uploaded 19 September 2026) |
| `1.0.11+12` | PR #72: sounds (answers, timer ticks, whistles, crowd cheers, coin clink) and confetti for 3 stars or a new best ← **latest** (archived 19 September 2026, not uploaded yet) |
...
| Item | Status |
|---|---|
| In-app purchases | Built in v1.0.8 (`coins_small`, `remove_ads`, `remove_ads_bundle`), acknowledged on completion. The owner created and activated the three products on 18 September 2026 (one backwards-compatible `buy` option each); test purchases pending |
