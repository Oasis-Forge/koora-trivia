...
| `1.0.9+10` | PRs #66–#67: purchase delivery fix · shop retries products and logs why · Next level main button · coin badge opens the shop · quick play skips recent questions and prefers unlocked levels · hint for a rewarded ad · new privacy link ← **latest** (archived 19 September 2026, not uploaded yet) |
