...
void main() {
  ...
  test('لا توجد خيارات من نوع "كل ما سبق" أو "لا يوجد"', () {
    // هذه الخيارات تفقد معناها لأن ترتيب الخيارات يُخلط قبل العرض، والنفي المجرّد
    // («لا شيء»، «لا أحد»، «لم يحدث») مرفوض بقرار صاحب التطبيق.
    const banned = [
      'كل ما سبق',
      'جميع ما سبق',
      'كل ما ذكر',
...
String _fingerprint(String input) {
  // تُطبَّع مثل النص، وإلا لا تطابق «على» و«إلى» أبداً بعد تحويل الألف.
  final noise = const [
